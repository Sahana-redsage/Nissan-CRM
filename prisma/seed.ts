...
async function main() {
  ...
  const customers = [
    ...
    { name: 'Ravi Bhushan', email: 'ravi.bhushan@email.com', phone: '+91-9876543260', address: 'Ring 3636, Adilabad', city: 'Hyderabad', state: 'Telangana', pincode: '504001', vehicleNumber: 'TS09FY1234', vehicleMake: 'Maruti Suzuki', vehicleModel: 'S-Cross', vehicleYear: 2019, purchaseDate: '2019-09-20', lastServiceDate: '2024-09-06', nextServiceDueDate: '2025-12-17', totalMileage: 44000 },
    { name: 'Tanya Kapoor', email: 'tanya.kapoor@email.com', phone: '+91-9876543261', alternatePhone: '+91-9876543282', address: 'Belt 3737, Karimnagar', city: 'Hyderabad', state: 'Telangana', pincode: '505001', vehicleNumber: 'TS09FZ5678', vehicleMake: 'Hyundai', vehicleModel: 'Tucson', vehicleYear: 2020, purchaseDate: '2020-10-11', lastServiceDate: '2024-08-18', nextServiceDueDate: '2025-12-11', totalMileage: 43000 },
    { name: 'Siddharth Nair', email: 'siddharth.nair@email.com', phone: '+91-9876543262', address: 'Segment 3838, Warangal', city: 'Hyderabad', state: 'Telangana', pincode: '506001', vehicleNumber: 'TS09GA9012', vehicleMake: 'Honda', vehicleModel: 'CR-V', vehicleYear: 2018, purchaseDate: '2018-06-28', lastServiceDate: '2024-07-23', nextServiceDueDate: '2025-12-12', totalMileage: 70000 },
    { name: 'Kriti Sharma', email: 'kriti.sharma@email.com', phone: '+91-9876543263', address: 'Division 3939, Khammam', city: 'Hyderabad', state: 'Telangana', pincode: '507001', vehicleNumber: 'TS09GB3456', vehicleMake: 'Tata', vehicleModel: 'Punch', vehicleYear: 2021, purchaseDate: '2021-04-13', lastServiceDate: '2024-09-07', nextServiceDueDate: '2025-12-13', totalMileage: 29000 },
    { name: 'Aryan Malhotra', email: 'aryan.malhotra@email.com', phone: '+91-9876543264', alternatePhone: '+91-9876543281', address: 'Section 4040, Nalgonda', city: 'Hyderabad', state: 'Telangana', pincode: '508001', vehicleNumber: 'TS09GC7890', vehicleMake: 'Mahindra', vehicleModel: 'KUV100', vehicleYear: 2017, purchaseDate: '2017-02-09', lastServiceDate: '2024-08-13', nextServiceDueDate: '2025-12-14', totalMileage: 86000 },
    { name: 'Priyanka Roy', email: 'priyanka.roy@email.com', phone: '+91-9876543265', address: 'Quarter 4141, Rangareddy', city: 'Hyderabad', state: 'Telangana', pincode: '500075', vehicleNumber: 'TS09GD1234', vehicleMake: 'Toyota', vehicleModel: 'Yaris', vehicleYear: 2019, purchaseDate: '2019-10-16', lastServiceDate: '2024-09-04', nextServiceDueDate: '2025-12-15', totalMileage: 50000 },
  ];
